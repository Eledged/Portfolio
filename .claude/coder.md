...
This is a personal portfolio website built with **React 19**, **TypeScript 6**, and **Vite 8**. The project uses React for component-based UI, TypeScript for type safety, and Vite for fast development and optimized builds.
...
- Create a new `.tsx` file in `src/` with PascalCase name
